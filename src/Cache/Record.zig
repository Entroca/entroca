...
pub fn create(comptime config: Config) type {
    return packed struct {
        ...
        empty: config.record.EmptyType(),
        hash: config.record.HashType(),
        key: config.record.KeyType(),
        key_length: config.record.KeyLengthType(),
        value: config.record.ValueType(),
        value_length: config.record.ValueLengthType(),
        total_length: config.record.TotalLengthType(),
        data: config.record.DataType(),
        temperature: config.record.TemperatureType(),
        ttl: config.record.TtlTotalType(),
        padding: config.record.PaddingType(),
